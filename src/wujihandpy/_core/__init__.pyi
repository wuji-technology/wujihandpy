...
from . import filter
from . import logging
__all__: list[str] = ['Finger', 'Hand', 'IController', 'Joint', 'TouchBoard', 'filter', 'logging']
class Finger:
...
class Joint:
    ...
    def write_joint_target_position_unchecked(self, value: typing.SupportsFloat, timeout: typing.SupportsFloat = 0.5) -> None:
        ...
class TouchBoard:
    def __init__(self, serial_number: str | None = None, usb_pid: typing.SupportsInt = 0x5700, usb_vid: typing.SupportsInt = 0x0483) -> None:
        ...
    def read_tactile(self, timeout: typing.SupportsFloat = 1.0) -> numpy.typing.NDArray[numpy.float32]:
        ...
    def read_tactile_raw(self, timeout: typing.SupportsFloat = 1.0) -> numpy.typing.NDArray[numpy.int16]:
        ...
    def get_tactile(self) -> numpy.typing.NDArray[numpy.float32] | None:
        ...
    def get_tactile_raw(self) -> numpy.typing.NDArray[numpy.int16] | None:
        ...
    @property
