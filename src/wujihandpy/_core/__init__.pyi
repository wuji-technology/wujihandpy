...
from . import filter
from . import logging
__all__: list[str] = ['Finger', 'Hand', 'IController', 'Joint', 'TactileBoard', 'TactileFrame', 'TactileHandedness', 'filter', 'logging']
class TactileHandedness:
    LEFT: typing.ClassVar[TactileHandedness]
    RIGHT: typing.ClassVar[TactileHandedness]
class TactileFrame:
    @property
    ...
    def crc_valid(self) -> bool:
        ...
    @property
    def pressure(self) -> numpy.typing.NDArray[numpy.int16]:
        """24x32 pressure matrix as numpy array."""
        ...
class TactileBoard:
    ...
    def is_connected(self) -> bool:
        ...
    def read_frame(self, timeout_ms: int = 100) -> TactileFrame:
        ...
    def start_streaming(self, callback: typing.Callable[[TactileFrame], None]) -> None:
        ...
    def stop_streaming(self) -> None:
        ...
    def handedness(self) -> TactileHandedness:
        ...
